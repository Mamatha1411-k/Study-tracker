...
# Sets the hardcoded starting baseline to July 1, 2026
st.caption("📅 Date: 1 July 2026 | Day 1 Kickoff Core Synchronization Active")
...
with left_panel:
    ...
    if not st.session_state.timer_running:
        ...
        if st.button("🔴 STOP & SAVE SESSION", use_container_width=True):
            ...
            # If completing a solid session, bump the streak up to 1 if it's currently 0
